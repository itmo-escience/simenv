...
//
//  val environment = new CoreRamEnvironment(nodes, networks)
//  val estimator = new CoreRamEstimator(environment)
//
//  @Test
//  def testDynamic() = {
...
//      iterationCount = 50)
//
//    val ctx = new BasicContext[DaxTask, CoreRamNode](environment, Schedule.emptySchedule(),
...
//    println(env.asInstanceOf[CoreRamEnvironment].vms.map(x => s"${x.cores}; ${x.ram}"))
//    print("Finished")
//  }
//}
