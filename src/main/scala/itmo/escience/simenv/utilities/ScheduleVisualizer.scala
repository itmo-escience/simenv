...
import itmo.escience.simenv.environment.entities.{ScheduleItem, Schedule}
...
//    var nodes: List[itmo.escience.simenv.environment.entities.Node] = List()
...
//
//    var node: itmo.escience.simenv.environment.entities.Node = null
//    var n: Int = 0
//    for (n <- nodes.indices) {
//      val node: itmo.escience.simenv.environment.entities.Node = nodes(n)
