...
//import itmo.escience.simenv.environment.entitiesimpl.{CoreRamEnvironment, SingleAppWorkload}
...
//
//  def environmentConfig(context: Context[DaxTask, CoreRamNode], schedule: Schedule): CoreRamEnvironment = {
//
