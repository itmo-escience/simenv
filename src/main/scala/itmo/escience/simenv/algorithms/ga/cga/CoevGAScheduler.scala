...
//import itmo.escience.simenv.environment.entities.{Schedule, Context, CoreRamNode, DaxTask}
//import itmo.escience.simenv.environment.entitiesimpl.CoreRamEnvironment
...
//
//  def scheduleAndConfiguration(context: Context[DaxTask, CoreRamNode], environment: Environment[CoreRamNode]): (Schedule, CoreRamEnvironment) = {
...
//    var curEnvironment: CoreRamEnvironment = configurator.environmentConfig(context, curSched)
