...
//    val wfPath = ".\\resources\\tplgs\\test1all.json"
    val wfPath = ".\\resources\\tplgs\\2406.json"
    val envPath = ".\\resources\\envs\\2406.json"
...
//    val seedSolution2 = ".\\resources\\solutions\\rnd3.json"
    ...
    val localNet = 100000 // Bandwidth in rack in MB\sec
    val globNet = 1000 // bandwidth between racks in MB\sec
    // запуск
    val fitFlag = 1
    /*
         0 - throughput
    ...
    val storm = new StormScheduler(wfPath, envPath, globNet, localNet, null, fitFlag)
...
//    val tStormResult = TstormAlg.run(wfPath, envPath)
